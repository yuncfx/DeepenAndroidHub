...
import com.deepen.android.hub.performance.adapter.NewsAdapter;
import com.deepen.android.hub.performance.adapter.OnFeedShowCallBack;
import com.deepen.android.hub.performance.async.ThreadPoolUtils;
import com.deepen.android.hub.performance.bean.NewsItem;
import com.deepen.android.hub.performance.launchstarter.DelayInitDispatcher;
import com.deepen.android.hub.performance.net.JobSchedulerService;
import com.deepen.android.hub.performance.net.RetrofitNewsUtils;
import com.deepen.android.hub.performance.tasks.delayinittask.DelayInitTaskA;
import com.deepen.android.hub.performance.tasks.delayinittask.DelayInitTaskB;
import com.deepen.android.hub.performance.utils.ExceptionMonitor;
...
public class PerformanceMainActivity extends AppCompatActivity implements OnFeedShowCallBack {
...
//                }
        ...
        new AsyncLayoutInflater(PerformanceMainActivity.this).inflate(R.layout.activity_main,
                null, new AsyncLayoutInflater.OnInflateFinishedListener() {
                    @Override
                    public void onInflateFinished(@NonNull View view, int i, @Nullable ViewGroup viewGroup) {
                        setContentView(view);
                        mRecyclerView = findViewById(R.id.recycler_view);
                        mRecyclerView.setLayoutManager(new LinearLayoutManager(PerformanceMainActivity.this));
                        mRecyclerView.setAdapter(mNewsAdapter);
                        mNewsAdapter.setOnFeedShowCallBack(PerformanceMainActivity.this);
                    }
                });
...
//        setContentView(R.layout.activity_main);
        X2C.setContentView(PerformanceMainActivity.this, R.layout.activity_main);
